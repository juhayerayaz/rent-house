        ...
        <div class="card w-96 bg-base-100 shadow-xl">
            ...
            <div class="card-body">
                <h2 class="card-title text-primary font-bold">
                    ...
                    <div class="rounded flex items-center px-3 py-1 bg-primary text-white float-left absolute mt-[-100px] ml-[-35px] text-sm"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
